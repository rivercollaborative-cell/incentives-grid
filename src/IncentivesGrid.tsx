  ...
  
{
  ...
  sectors: ["AgTech", "AI", "EV/AV", "BioTech"],
...

{
  ...
  sectors: ["AgTech", "AI", "EV/AV", "FinTech", "BioTech", "Advanced Manufacturing"],
  stages: ["Scale-up", "Enterprise"],
...
{ 
  ...
  country: "USA", jurisdiction: "Michigan", 
...
{ 
  ...
  country: "USA", 
  jurisdiction: "Michigan", type: "Economic Development Fund", 
  sectors: ["AgTech", "AI", "EV/AV", "FinTech", "BioTech", "Advanced Manufacturing"], 
  stages: ["Scale-up", "Enterprise"], sizes: ["Up to $100M", "$1M–$10M"], 
...

{
  ...
  sectors: ["AgTech", "AI", "EV/AV", "FinTech"],
  stages: ["Startup", "Scale-up", "Enterprise"],
  sizes: ["Varies"],
...
{
  id: "sbir",
  program: "Small Business Association - Small Business Innovation Research (SBIR)",
  country: "USA",
  jurisdiction: "USA",
...
{
  id: "sttr",
  program: "Small Business Association - Small Business Technology Transfer (SBTT)",
  country: "USA",
